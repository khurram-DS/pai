...
#table 5
 ...
 #table2           
            ...
            if st.checkbox('6- التوزيع القطاعي للمنشآت الصناعية المتوسطة بحسب التصنيف الصناعي الدولي الموَّحد لجميع الأنشطة الاقتصادية '):       
                ...
                st.markdown(linko, unsafe_allow_html=True)
                st.markdown("**Figure 8 : Bar chart for the total {} based on 'عدد العاملين الكويتيين' and based on 'Code (ISIC 4)'**".format(option))
                ...
                st.markdown("**Figure 9 : Bar chart for the total {} based on 'رأس المال (ألف دينار)' and based on 'Code (ISIC 4)'**".format(option))
